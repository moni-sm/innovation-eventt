...
export default function PartnersFooter({ partners, branding }) {
  return (
    <footer className="relative bg-[#004771] text-white border-t border-[#003859] pt-10 pb-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Main Partners Strip */}
        <div className="flex flex-col lg:flex-row items-center lg:items-center justify-between gap-8 lg:gap-8 pb-10 border-b border-white/15">
          ...
          <div className="hidden lg:block w-px h-16 bg-white/20 mx-2 lg:mx-4 flex-shrink-0 self-center"></div>

          {/* Right: Infinite Marquee for Ecosystem Logos */}
          <div className="flex-1 w-full min-w-0 overflow-hidden relative py-2">
            
            {/* Edge Fade Gradients */}
            <div className="absolute left-0 top-0 bottom-0 w-8 sm:w-14 bg-gradient-to-r from-[#004771] to-transparent z-10 pointer-events-none hidden sm:block"></div>
            <div className="absolute right-0 top-0 bottom-0 w-8 sm:w-14 bg-gradient-to-l from-[#004771] to-transparent z-10 pointer-events-none hidden sm:block"></div>
        ...
        <FadeIn direction="up" delay={150}>
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-blue-100/75 gap-4">
            <div>
            ...
            <div className="flex items-center gap-6">
              ...
              <span>•</span>
              <span className="hover:text-white cursor-pointer">Terms of Registration</span>
              <span>•</span>
              <span className="hover:text-white cursor-pointer">Contact Event Support</span>
            </div>
          </div>
        </FadeIn>
